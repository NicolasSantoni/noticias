<div class="sair">
  ...
  echo
    '<div>
      <h>Bem vindo '.$_SESSION['user']->nome.'!</h>
      <a href="'.HOME_URI.'usuario/logout">
      <svg width="4em" height="4em" viewBox="0 0 16 16" class="bi_bi-box-arrow-in-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
